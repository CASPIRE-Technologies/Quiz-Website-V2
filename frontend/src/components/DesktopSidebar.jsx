  ...
  return (
    <aside className="desktop-sidebar">
      <div className="sidebar-header">
        ...
        <div>
          <div className="logo-title" style={{ fontSize: '18px', fontWeight: 700 }}>{t('app.name')}</div>
          <div className="logo-subtitle" style={{ fontSize: '11px', color: 'var(--color-secondary)', fontWeight: 600 }}>{t('app.subtitle')}</div>
        </div>
      </div>

      <div className="sidebar-nav">
        <div style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', color: 'var(--color-text-muted)', padding: '8px 12px' }}>{t('nav.navigation')}</div>

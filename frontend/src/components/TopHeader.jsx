...
import { Search, Bell, Menu, X, ShieldAlert, Home, BookOpen, Award, User, LogOut } from 'lucide-react';
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          >
            ...
            <button onClick={() => { logoutUser(); setMobileMenuOpen(false); navigate('/login'); }} className="nav-item" style={{ color: 'var(--color-error)', marginTop: 'auto' }}>
